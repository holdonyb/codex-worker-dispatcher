...
- Current phase: `v0.1.1` public documentation refinement completed
...
- Completed in `v0.1.1`: root-level Codex Skill layout, default install path switch to `$CODEX_HOME/skills` or `~/.codex/skills`, packaging remap, README reframing, public sharing guides, public re-release, and lifecycle reconciliation fix for completed tasks after identity reuse
...
- Hosted validation: all six Windows, Ubuntu, and macOS jobs for Python 3.10 and 3.14 passed in [GitHub Actions run 29653928879](https://github.com/holdonyb/codex-worker-dispatcher/actions/runs/29653928879)
...
- Release: [v0.1.1](https://github.com/holdonyb/codex-worker-dispatcher/releases/tag/v0.1.1)
